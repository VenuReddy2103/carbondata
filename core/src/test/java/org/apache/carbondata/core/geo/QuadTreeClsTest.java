...
public class QuadTreeClsTest {
    ...
    public void testCreateHashID() throws Exception {
        ...
        System.out.println(grid.createHashID(4,4));
        System.out.println(grid.createHashID(8,7));
        System.out.println(grid.createHashID(7,8));
    ...
    public void testQueryOne() throws Exception {
        ...
        System.out.println(twoLevel_TOPRIGHT_BOTTOMLEFT.getGrid().getHashIDRange()[0]);
        System.out.println(twoLevel_TOPRIGHT_BOTTOMLEFT.getGrid().getHashIDRange()[1]);
        //oneLevel_BOTTOMLEFT
        //null
