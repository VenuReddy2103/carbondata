...
public class GeoHashDefault implements CustomIndex<Long, String, List<Long[]>> {
  ...
  private void gridExpansionArea() {
    ...
    // this.udfRowStartNumber = (int)((this.CalculateMaxLongitude - this.userDefineMaxLongitude) /
    // this.deltaY);
    // this.udfRowEndNumber = this.totalRowNumber;
    // this.udfCloumnEndNumber = (int)((this.CalculateMaxLatitude - this.userDefineMaxLatitude)/
    // this.deltaX);
    // his.udfCloumnStartNumber = 1;
